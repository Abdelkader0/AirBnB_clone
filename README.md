...
To see the fundamental background of the project visit the [Wiki](https://github.com/Abdelkader0/AirBnB_clone/wiki).
...
```bash
git clone https://github.com/Abdelkader0/AirBnB_clone.git
```
